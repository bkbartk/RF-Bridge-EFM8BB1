...
SI_SEGMENT_VARIABLE(ReadUARTData, static bool, SI_SEG_DATA) = true;
SI_SEGMENT_VARIABLE(last_sniffing_command, static uart_command_t, SI_SEG_XDATA) = RF_CODE_RFIN;
